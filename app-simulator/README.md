...
- 確認アプリ専用の作業コピーはGitHubの状態へ同期し、npmの生成ファイルが最新版取得を妨げないようにする
...
確認アプリが管理する `~/Library/Application Support/アプリ画面確認/アプリ` はGitHubの確認用コピーです。この中のコードを直接編集しても、次回起動時にGitHubの内容へ戻ります。変更はGitHub側へ反映してください。
